...
<head>
    ...
    <style>
        ...
        .btn-info {
            background-color: #5bc0de; /* Custom button color */
            border-color: #46b8da; /* Button border color */
        }
        .btn-info:hover {
            background-color: #31b0d5; /* Darker on hover */

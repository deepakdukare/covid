...
if (strlen($_SESSION['aid']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $stmt = $con->prepare("INSERT INTO tblphlebotomist (EmpID, FullName, MobileNumber) VALUES (?, ?, ?)");
        $stmt->bind_param("sss", $empid, $fname, $mnumber); // "sss" means all three parameters are strings
...
<?php 
} // Closing the else statement for session validation
?>

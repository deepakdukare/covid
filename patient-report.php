...
<head>
    ...
    <style>
        ...
        table {
            border-radius: 8px;
            overflow: hidden; /* To avoid corners sticking out */
        }
    </style>
</head>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    ?>
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Search Result Against '<?php echo $searchdata; ?>'</h1>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="patient-report-details.php?tid=<?php echo $row['testid']; ?>&&oid=<?php echo $row['OrderNumber']; ?>" class="btn btn-info btn-sm" target="_blank">View Details</a>
                                                    </td>
                                                </tr>
                                            <?php $cnt++; } ?>
                                        </tbody>

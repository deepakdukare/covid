...
if(isset($_POST['submit'])){
    // Getting post values and sanitizing them
    $fname = mysqli_real_escape_string($con, $_POST['fullname']);
    $mnumber = mysqli_real_escape_string($con, $_POST['mobilenumber']);
    $dob = mysqli_real_escape_string($con, $_POST['dob']);
    $govtid = mysqli_real_escape_string($con, $_POST['govtissuedid']);
    $govtidnumber = mysqli_real_escape_string($con, $_POST['govtidnumber']);
    ...
    $query1 = "INSERT INTO tblpatients (FullName, MobileNumber, DateOfBirth, GovtIssuedId, GovtIssuedIdNo, FullAddress, State) 
               VALUES (?, ?, ?, ?, ?, ?, ?)";
    $stmt1 = mysqli_prepare($con, $query1);
    mysqli_stmt_bind_param($stmt1, "sssssss", $fname, $mnumber, $dob, $govtid, $govtidnumber, $address, $state);
    $result1 = mysqli_stmt_execute($stmt1);

    // Insert test record information
    $query2 = "INSERT INTO tbltestrecord (PatientMobileNumber, TestType, TestTimeSlot, OrderNumber) 
               VALUES (?, ?, ?, ?)";
    $stmt2 = mysqli_prepare($con, $query2);
    mysqli_stmt_bind_param($stmt2, "ssss", $mnumber, $testtype, $timeslot, $orderno);
